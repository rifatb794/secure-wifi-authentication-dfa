...
A **Python-based desktop cybersecurity authentication system** built using **Tkinter** that simulates a **Secure WiFi Authentication Process using Deterministic Finite Automata (DFA)**.

This project demonstrates how **DFA concepts, authentication protocols, and cybersecurity logic** can be integrated into a real-time interactive system with **state monitoring, risk detection, authentication logging, and access control simulation**.
...
![State Transition Diagram](screenshots/state-transition-diagram.png)
...
![Transition Process](screenshots/transition.png)
...
![DFA Diagram](screenshots/dfa-diagram.png)
...
![Authentication Logs](screenshots/logs.png)
...
![Access Granted](screenshots/success.png)
...
![Authentication Report](screenshots/report.png)
